...
<div class="pages">
    ...
    <div class="9">
        <h3>Game</h3>
            <script src="UnityCode/PatchesAndUpdates/TemplateData/UnityProgress.js"></script>  
            <script src="UnityCode/PatchesAndUpdates/Build/UnityLoader.js"></script>
            <script>
                var gameInstance = UnityLoader.instantiate("gameContainer", "UnityCode/PatchesAndUpdates/Build/PatchesAndUpdates.json", {onProgress: UnityProgress});
            </script>
