...
-- *****
INSERT INTO answers VALUES (null, "external devices.", @q, TRUE);
INSERT INTO answers VALUES (null, "an unsecure wi-fi hotspot.", @q, FALSE);
INSERT INTO answers VALUES (null, "email.", @q, FALSE);
...
INSERT INTO answers VALUES (null, "report the email to authorities.", @q, TRUE);
INSERT INTO answers VALUES (null, "avoid clicking the link and navigate to the bank’s website independently.", @q, FALSE);
...
INSERT INTO answers VALUES (null, "use software specifically designed to store and protect your passwords.", @q, FALSE);
INSERT INTO answers VALUES (null, "keep them in a file on your computer’s desktop.", @q, FALSE);
INSERT INTO answers VALUES (null, "use the same passwords for all your accounts so they’re easy to memorize.", @q, TRUE);

INSERT INTO questions VALUES (null, "Of the options below, the best way to create a strong password is to:");
SET @q := LAST_INSERT_ID();
-- *****
INSERT INTO answers VALUES (null, "use an online password generator.", @q, FALSE);
...
INSERT INTO answers VALUES (null, "repeat the same 4 characters 10 times to make it really long.", @q, TRUE);
...
SET @q := LAST_INSERT_ID();
-- *****
INSERT INTO answers VALUES (null, "Heuristics and virus definition.", @q, FALSE);
...
INSERT INTO answers VALUES (null, "Parsing and sweeping.", @q, TRUE);
...
INSERT INTO answers VALUES (null, "Cover your screen so nearby hackers can’t see what you’re doing.", @q, FALSE);
INSERT INTO answers VALUES (null, "Always log out of your accounts when you’re done using them.", @q, TRUE);
